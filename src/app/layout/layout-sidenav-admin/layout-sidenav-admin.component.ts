...
export class LayoutSidenavAdminComponent implements AfterViewInit {
  public niveisAcessoActionsENUM = NiveisAcessoActionsENUM;
  public farmavetroutes = ImportadorDespesasRotasENUM;
  ...
  constructor(private router : Router, private route: ActivatedRoute, public appService: AppService, private layoutService: LayoutService) {
    // Set host classes
  ...
  isActive(url) {   
    return this.router.isActive(url, false); //this.route.snapshot['_routerState'].url === url
  }
