...
@Component({
    selector: 'app-ngselect-despesas',
    templateUrl: './ngselect-despesas.component.html',  
    providers: [{
         provide: NG_VALUE_ACCESSOR,
         useExisting: NgselectDespesasComponent,
         multi: true
       }]
  })
  export class NgselectDespesasComponent implements OnInit, ControlValueAccessor {
    ...
    public placeholder  = "Digite a Despesa"
